  ...
  return (
    <nav>
      ...
      <ul className="mainul">
        ...
        <li>
          <a href="#" className="navlinkdrop karyemer">
            Karyera mərkəzi
          </a>
          <i className="fa-solid fa-angle-down down"></i>
        ...
        <li>
          <a href="#" className="navlink">
            <abbr title="Korporativ">Korporativ</abbr>
          </a>
        </li>
        <li>
          <a href="#" className="navlink">
            <abbr title="Əlaqə">Əlaqə</abbr>
          </a>
        </li>
      </ul>
      <div className="nav-third-box">
        <div className="mode-socials">
          <div className="mode">
            {isDarkMode === "dark" ? (
              <span>
                İşıqları <br /> yandır
        ...
        <div className="resp-menu" ref={navRef}>
          <ul className="mainul2">
            <li onClick={() => toggleSubmenu(1)}>
              ...
              <i className="fa-solid fa-angle-down down"></i>
              <div
                className={`nav-dropdown21 ${
                  openSubmenu === 1 ? "show-nav-dropdown2" : ""
                }`}
              >
                <ul className="drop-inside">
                  <li>
            ...
            <li onClick={() => toggleSubmenu(2)}>
              ...
              <i className="fa-solid fa-angle-down down"></i>
              <div
                className={`nav-dropdown22 ${
                  openSubmenu === 2 ? "show-nav-dropdown2" : ""
                }`}
              >
                <ul className="drop-inside">
                  <li>
            ...
            <li onClick={() => toggleSubmenu(3)}>
              ...
              <i className="fa-solid fa-angle-down down"></i>
              <div
                className={`nav-dropdown23 ${
                  openSubmenu === 3 ? "show-nav-dropdown2" : ""
                }`}
              >
                <ul className="drop-inside">
                  <li>
